...
{
    public class MyActionValueBinder : IActionValueBinder
    {
        /// <summary>
        ...
        public  HttpActionBinding GetBinding(HttpActionDescriptor actionDescriptor)
        {
            if (actionDescriptor == null)
            {
                ...
                throw new ArgumentNullException("actionDescriptor can't be null");
            }
        ...
        public  HttpParameterBinding GetParameterBinding(HttpParameterDescriptor parameter)
        {
